...
class RecursiveLayerInterpretationTest {
    ...
    void testSimpleLayer() {
        ...
        Assertions.assertEquals(2, layers.keySet().size());
        Assertions.assertEquals(1, layers.get(1).size()); //section
        Assertions.assertEquals(1, layers.get(2).size()); //p
    ...
    void testSimpleLayer2() {
        ...
        Assertions.assertEquals(1, layers.get(1).size()); //section
        Assertions.assertEquals(3, layers.get(2).size()); //(section>)p, (section>)div, (section>)p
        Assertions.assertEquals(1, layers.get(3).size()); //(div>)p
        System.out.println(layers.get(1));
        System.out.println(layers.get(2));
    ...
    void testSimpleLayer3() {
        ...
        Assertions.assertEquals(3, layers.keySet().size());
        Assertions.assertEquals(1, layers.get(1).size()); //section
        Assertions.assertEquals(1, layers.get(2).size()); //(section>)div
        Assertions.assertEquals(1, layers.get(3).size()); //(div>)p
        System.out.println(layers.get(1));
        System.out.println(layers.get(2));
        System.out.println(layers.get(3));
    ...
    void testSimpleLayer4() {
        ...
        Assertions.assertEquals(1, layers.get(1).size()); //section
        Assertions.assertEquals(1, layers.get(2).size()); //(section>)div
        Assertions.assertEquals(2, layers.get(3).size()); //(div>)p, (div>)p
        System.out.println(layers.get(1));
        System.out.println(layers.get(2));
        System.out.println(layers.get(3));
    }
    ...
    void testMultiLayer() {
        ...
        Assertions.assertEquals(3, layers.keySet().size());
        Assertions.assertEquals(1, layers.get(1).size()); //outer
        Assertions.assertEquals(2, layers.get(2).size()); //(outer>)section, (outer>)div
        Assertions.assertEquals(2, layers.get(3).size()); //(section>)p, (div>)p
        System.out.println(layers.get(1));
        System.out.println(layers.get(2));
        System.out.println(layers.get(3));
    }
